---
title: Data Citadel
description: Endpoint data-security suite — removable-drive protection, lockdown, monitoring, real-time incident response, and secure sync.
order: 3
tech: [Python, MQTT, Microservices, Linux, Bash]
...
| **Timeline** | TODO |
| **Team** | TODO |
| **Stack** | Python · MQTT · Microservices · Linux |
| **Status** | TODO |
